...
- **harness ยังไม่เคยลองกับแอปจริง** — ทดสอบได้แค่กับ starter เพราะ session ที่ทำ clone
  repo แอปไม่ได้ · ดู `testing-single-html.md` หัวข้อ "ย้าย harness ไปใช้กับแอปเดิม"
