...
โฟลเดอร์เก็บเทคนิค/ทริคการใช้ Claude Code และ claude.ai ที่เจอระหว่างทำงานจริง — ไม่ใช่ config ที่ระบบต้องอ่าน (ต่างจาก `skills/`, `agents/`) แค่เป็นสมุดจดสำหรับพี่ A เอง เพิ่มไฟล์ใหม่ได้เรื่อยๆ ตามหัวข้อที่เจอ
